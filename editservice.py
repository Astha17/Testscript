...
class Blog_ATS(unittest.TestCase):
    ...
    def test_blog(self):
        ...
        assert "Logged In"
        time.sleep(1)
        elem = driver.find_element_by_xpath("/html/body/div/div/div/div[2]/div/div/div/div/div[2]/div/div/p[2]")
        elem.click()
        time.sleep(1)
        ...
        elem = driver.find_element_by_xpath("/html/body/div/div/div/div[3]/table/tbody/tr[4]/td[8]/a")
        elem.click()
        ...
        elem.clear()
        elem.send_keys("Cooking chicken lowemin!!")
        time.sleep(3)
